...
namespace VahapYigit.Test.Crud
{
	...
	/// <summary>
	/// ProcessErrorLogCrud class used to access to the database using stored procedures.
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCode("LayerCake Generator", "3.7.1")]
	[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage()]
	public partial class ProcessErrorLogCrud : CrudBase<VahapYigit.Test.Models.ProcessErrorLog>
	{
		#region [ Constructor ]
		...
		/// User context.
		/// </param>
		public ProcessErrorLogCrud(IUserContext userContext)
			: base(userContext)
		{
			base.Initialize();
		}
		...
		/// </param>
		public override void Refresh(ref VahapYigit.Test.Models.ProcessErrorLog entity)
		{
			...
			if (entity == null)
			{
				throw new EntityNotFoundException(VahapYigit.Test.Models.ProcessErrorLog.EntityName, id);
			}
		}
		...
		/// The entity.
		/// </returns>
		public override VahapYigit.Test.Models.ProcessErrorLog GetById(long id)
		{
			using (var et = new ExecutionTracerService())
			{
				VahapYigit.Test.Models.ProcessErrorLog entity = null;

				var parameters = new Dictionary<string, object>();

				parameters.Add("@ProcessErrorLog_Id", id);

				var collection = base.ToEntityCollection("ProcessErrorLog_Get", parameters, withDeepMapping: false);
		...
		/// </returns>
		public override TCollection<VahapYigit.Test.Models.ProcessErrorLog> Search(ref SearchOptions options)
		{
			TCollection<VahapYigit.Test.Models.ProcessErrorLog> collection = null;
			...
			using (var et = new ExecutionTracerService())
			{
				...
				using (var dbReader = this.ToDataReader("ProcessErrorLog_Search", parameters, out dbConnection))
				{
		...
		public override int Count(SearchOptions options = null)
		{
			using (var et = new ExecutionTracerService())
			{
				...
				return base.ExecuteScalar<int>("ProcessErrorLog_Count", parameters);
			}
		}
		...
		/// </returns>
		public override int Save(ref VahapYigit.Test.Models.ProcessErrorLog entity, SaveOptions options = null)
		{
			ConditionChecker.Required(
				entity != null,
				new ArgumentNullException("entity"));
		...
		/// The number of affected rows.
		/// </returns>
		internal int PersistWithChildren(ref VahapYigit.Test.Models.ProcessErrorLog entity, ObjectIDGenerator idGenerator, SaveOptions options = null)
		{
			int rowCount = 0;
		...
		/// The number of affected rows.
		/// </returns>
		public override int Delete(VahapYigit.Test.Models.ProcessErrorLog entity)
		{
			int rowCount = 0;
		...
		public override int Delete(long id)
		{
			...
			using (var scope = TransactionScopeHelper.CreateDefaultTransactionScope())
			{
				...
				rowCount = base.ExecuteScalar<int>("ProcessErrorLog_Delete", parameters);
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.ProcessErrorLog> Map(IDataReader dbReader)
		{
			var collection = new TCollection<VahapYigit.Test.Models.ProcessErrorLog>();

			while (dbReader.Read())
			{
				var entity = new VahapYigit.Test.Models.ProcessErrorLog();
				entity.Map(dbReader, base.UserContext);

				var currentProcessErrorLog = collection.FirstOrDefault(i => i.Id == entity.Id);
				if (currentProcessErrorLog == null)
				{
					collection.Add(entity);
					currentProcessErrorLog = entity;
				}
			}
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.ProcessErrorLog> Map(DataTable source)
		{
			var collection = new TCollection<VahapYigit.Test.Models.ProcessErrorLog>();
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.ProcessErrorLog> DeepMap(IDataReader dbReader)
		{
			var collection = new TCollection<VahapYigit.Test.Models.ProcessErrorLog>();
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.ProcessErrorLog> DeepMap(DataTable source)
		{
			var collection = new TCollection<VahapYigit.Test.Models.ProcessErrorLog>();
		...
		partial void OnSaving(ref VahapYigit.Test.Models.ProcessErrorLog entity, SaveOptions options);
		partial void OnSaved(ref VahapYigit.Test.Models.ProcessErrorLog entity, SaveOptions option);
