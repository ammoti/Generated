...
namespace VahapYigit.Test.Services
{
	...
	public partial class ProcessLogService : IProcessLogService
	{
		...
		#region [ IProcessLogService Implementation ]
		...
		/// </param>
		public void Refresh(IUserContext userContext, ref VahapYigit.Test.Models.ProcessLog entity)
		{
		...
		/// The entity.
		/// </returns>
		public VahapYigit.Test.Models.ProcessLog GetById(IUserContext userContext, long id)
		{
			using (var et = new ExecutionTracerService())
			using (var db = new ProcessLogCrud(userContext))
			{
		...
		/// </returns>
		public int Save(IUserContext userContext, ref VahapYigit.Test.Models.ProcessLog entity, SaveOptions options = null)
		{
		...
		/// The number of affected rows.
		/// </returns>
		public int Delete(IUserContext userContext,VahapYigit.Test.Models.ProcessLog entity)
		{
			using (var et = new ExecutionTracerService())
			using (var db = new ProcessLogCrud(userContext))
			{
		...
		#region [ IProcessLogService Business Implementation ]
		...
		public int Purge(VahapYigit.Test.Core.IUserContext userContext)
		{
			using (var et = new ExecutionTracerService())
			{
				var business = new ProcessLogBusiness();
