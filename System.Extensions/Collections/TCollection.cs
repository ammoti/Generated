...
namespace System
{
	...
	/// </typeparam>
	[Serializable]
	[CollectionDataContract(Namespace = "System.Extensions.TCollection")]
	public class TCollection<T> : Collection<T>
	{
		...
		public TCollection(IEnumerable<T> source)
			: base(source.ToList())
		{
		}
	...
	public static class TCollectionExtensions
	{
		public static TCollection<T> ToTCollection<T>(this IEnumerable<T> source)
		{
			return new TCollection<T>(source);
		}

		public static TCollection<T> ToTCollection<T>(this IEnumerable<IEnumerable<T>> sources)
		{
			if (sources == null)
				return null;
