...
namespace VahapYigit.Test.Contracts
{
	...
	/// <summary>
	/// ExecutionTraceService Contract.
	/// </summary>
	...
	public partial interface IExecutionTraceService : IService
	{
		#region [ IExecutionTraceService ]
		...
		void Refresh(VahapYigit.Test.Core.IUserContext userContext, ref VahapYigit.Test.Models.ExecutionTrace entity);
		...
		VahapYigit.Test.Models.ExecutionTrace GetById(VahapYigit.Test.Core.IUserContext userContext, long id);
		...
		TCollection<VahapYigit.Test.Models.ExecutionTrace> Search(VahapYigit.Test.Core.IUserContext userContext, ref VahapYigit.Test.Core.SearchOptions options);
		...
		int Save(VahapYigit.Test.Core.IUserContext userContext, ref VahapYigit.Test.Models.ExecutionTrace entity, VahapYigit.Test.Core.SaveOptions options = null);
		...
		int Delete(VahapYigit.Test.Core.IUserContext userContext,VahapYigit.Test.Models.ExecutionTrace entity);
		...
		#region [ IExecutionTraceService Business ]
		#pragma warning disable 1591 // Disable 'missing XML comment for publicly visible type or member' warnings

		[OperationContract(Name = "Trace")]
		void Trace(VahapYigit.Test.Core.IUserContext userContext, VahapYigit.Test.Models.ExecutionTraceModel[] traces);
