...
namespace VahapYigit.Test.Contracts
{
	...
	public partial interface IProcessLogService : IService
	{
		#region [ IProcessLogService ]
		...
		void Refresh(VahapYigit.Test.Core.IUserContext userContext, ref VahapYigit.Test.Models.ProcessLog entity);
		...
		VahapYigit.Test.Models.ProcessLog GetById(VahapYigit.Test.Core.IUserContext userContext, long id);
		...
		TCollection<VahapYigit.Test.Models.ProcessLog> Search(VahapYigit.Test.Core.IUserContext userContext, ref VahapYigit.Test.Core.SearchOptions options);
		...
		int Save(VahapYigit.Test.Core.IUserContext userContext, ref VahapYigit.Test.Models.ProcessLog entity, VahapYigit.Test.Core.SaveOptions options = null);
		...
		int Delete(VahapYigit.Test.Core.IUserContext userContext,VahapYigit.Test.Models.ProcessLog entity);
		...
		#region [ IProcessLogService Business ]
