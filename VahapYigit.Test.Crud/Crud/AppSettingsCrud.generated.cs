...
namespace VahapYigit.Test.Crud
{
	...
	/// <summary>
	/// AppSettingsCrud class used to access to the database using stored procedures.
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCode("LayerCake Generator", "3.7.1")]
	[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage()]
	public partial class AppSettingsCrud : CrudBase<VahapYigit.Test.Models.AppSettings>
	{
		#region [ Constructor ]
		...
		/// User context.
		/// </param>
		public AppSettingsCrud(IUserContext userContext)
			: base(userContext)
		{
			base.Initialize();
		}
		...
		/// </param>
		public override void Refresh(ref VahapYigit.Test.Models.AppSettings entity)
		{
			...
			if (entity == null)
			{
				throw new EntityNotFoundException(VahapYigit.Test.Models.AppSettings.EntityName, id);
			}
		}
		...
		/// The entity.
		/// </returns>
		public override VahapYigit.Test.Models.AppSettings GetById(long id)
		{
			using (var et = new ExecutionTracerService())
			{
				VahapYigit.Test.Models.AppSettings entity = null;

				var parameters = new Dictionary<string, object>();

				parameters.Add("@AppSettings_Id", id);

				var collection = base.ToEntityCollection("AppSettings_Get", parameters, withDeepMapping: false);
		...
		/// </returns>
		public override TCollection<VahapYigit.Test.Models.AppSettings> Search(ref SearchOptions options)
		{
			TCollection<VahapYigit.Test.Models.AppSettings> collection = null;
			...
			using (var et = new ExecutionTracerService())
			{
				...
				using (var dbReader = this.ToDataReader("AppSettings_Search", parameters, out dbConnection))
				{
		...
		public override int Count(SearchOptions options = null)
		{
			using (var et = new ExecutionTracerService())
			{
				...
				return base.ExecuteScalar<int>("AppSettings_Count", parameters);
			}
		}
		...
		/// </returns>
		public override int Save(ref VahapYigit.Test.Models.AppSettings entity, SaveOptions options = null)
		{
			ConditionChecker.Required(
				entity != null,
				new ArgumentNullException("entity"));
		...
		/// The number of affected rows.
		/// </returns>
		private int Persist(ref VahapYigit.Test.Models.AppSettings entity, SaveOptions options = null)
		{
			...
			using (var et = new ExecutionTracerService(tag: entity.State.ToString()))
			{
				if (options.CheckUniqueConstraints)
				{
					...
					{
						searchOpts.Filters.Add(VahapYigit.Test.Models.AppSettings.ColumnNames.Id, FilterOperator.Different, entity.Id);
					}

					searchOpts.Filters.Add(VahapYigit.Test.Models.AppSettings.ColumnNames.Key, FilterOperator.Equals, entity.Key);

					if (this.HasResult(searchOpts))
					{
						ucErrors.Add(TranslationEnum.CrudAppSettingsKeyUniqueConstraint);
					}
				...
				parameters.Add("@AppSettings_Id", entity.Id);
				parameters.Add("@AppSettings_Key", entity.Key);
				parameters.Add("@AppSettings_Value", entity.Value);
				parameters.Add("@AppSettings_Description", entity.Description);

				var collection = base.ToEntityCollection("AppSettings_Save", parameters, withDeepMapping: false);
				if (!collection.IsNullOrEmpty())
				{
		...
		/// The number of affected rows.
		/// </returns>
		internal int PersistWithChildren(ref VahapYigit.Test.Models.AppSettings entity, ObjectIDGenerator idGenerator, SaveOptions options = null)
		{
			int rowCount = 0;
		...
		/// The number of affected rows.
		/// </returns>
		public override int Delete(VahapYigit.Test.Models.AppSettings entity)
		{
			int rowCount = 0;
		...
		public override int Delete(long id)
		{
			...
			using (var scope = TransactionScopeHelper.CreateDefaultTransactionScope())
			{
				...
				rowCount = base.ExecuteScalar<int>("AppSettings_Delete", parameters);
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.AppSettings> Map(IDataReader dbReader)
		{
			var collection = new TCollection<VahapYigit.Test.Models.AppSettings>();

			while (dbReader.Read())
			{
				var entity = new VahapYigit.Test.Models.AppSettings();
				entity.Map(dbReader, base.UserContext);

				var currentAppSettings = collection.FirstOrDefault(i => i.Id == entity.Id);
				if (currentAppSettings == null)
				{
					collection.Add(entity);
					currentAppSettings = entity;
				}
			}
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.AppSettings> Map(DataTable source)
		{
			var collection = new TCollection<VahapYigit.Test.Models.AppSettings>();
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.AppSettings> DeepMap(IDataReader dbReader)
		{
			var collection = new TCollection<VahapYigit.Test.Models.AppSettings>();
		...
		/// A collection.
		/// </returns>
		protected override TCollection<VahapYigit.Test.Models.AppSettings> DeepMap(DataTable source)
		{
			var collection = new TCollection<VahapYigit.Test.Models.AppSettings>();
		...
		partial void OnSaving(ref VahapYigit.Test.Models.AppSettings entity, SaveOptions options);
		partial void OnSaved(ref VahapYigit.Test.Models.AppSettings entity, SaveOptions option);
